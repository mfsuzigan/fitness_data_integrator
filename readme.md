...
<div style="display: flex; justify-content: center; gap: 10px;">
    <img src="static/media/web_app.jpg" alt="Web app" style="width: 30%;">
    <img src="static/media/balanca.jpg" alt="Omron HBF-415C" style="width: 30%;">
</div>
<div style="text-align: center">
    <img src="static/media/sheets2.png" alt="Planilha no Google Sheets" width="80%" height="60%">
</div>
<div style="text-align: center; padding-top: 10px">
    <img src="static/media/sheets.png" alt="Planilha no Google Sheets" width="80%" height="60%">
</div>
